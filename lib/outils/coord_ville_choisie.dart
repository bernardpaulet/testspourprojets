...
class CoordVilleChoisie extends StatefulWidget {

  _CoordVilleChoisie createState() => new _CoordVilleChoisie();

}

class _CoordVilleChoisie extends State<CoordVilleChoisie> {
