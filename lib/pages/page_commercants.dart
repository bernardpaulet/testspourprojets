...
class _PageCommerces extends State<PageCommerces> {
      ...
      return new Scaffold(
        ...
        body: new Container(
          color: Theme.of(context).primaryColor,
            ...
            child: (maListeCommerces == null)? chargementEnCours(): listeRetour(context),
        ),// fin container
  ...
  Widget listeRetour(context){
    fonctionConversion();
    triSurDistance();
    message1 = "Test alerte";
    message2 = "Message de test d'alerte";
    print("context hashcode : $context.hashCode");
    //AlerteConnexion().methodeAlerte();
    //AlerteConnexion(context);
    AlerteConnexion().alerteConnexion(context);
